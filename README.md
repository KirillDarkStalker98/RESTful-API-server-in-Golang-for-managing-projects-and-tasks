...
* (Необязательно) Для корректного отображения ответов при запросах, нужно закомментировать связи в моделях данных в файле GAPi.go, после миграции базы данных.
